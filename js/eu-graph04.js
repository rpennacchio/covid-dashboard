d3.csv("https://www.francetvinfo.fr/docs/covid19/data/owid_top5_newdc_eu.csv").then(data => {
  const graphCfg = {
    target: `#eu-graph04`,
    title: `Evolution du nombre de nouveaux décès en Europe`,
    subtitle: `en moyenne lissée du nombre de morts, depuis le [[startDate]]*`,
    note: `* en France et dans les cinq pays européens qui comptent actuellement le plus grand nombre de nouveaux décès`,
